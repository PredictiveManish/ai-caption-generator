...
def main():
    ...
    with col2:
        st.markdown("### 📊 Steps")
        steps = ["1. Upload", "2. Extract Audio", "3. Transcribe", "4. Make SRT", "5. Add Subtitles"]
        for step in steps:
            ...
            if st.button("🚀 Start Processing", type="primary", use_container_width=True):
                ...
                try:
                    ...
                    try:
                        ...
                        st.info("Saved video without subtitles (but SRT is still available)")
                    except:
                ...
                with col2:
                    ...
                    # SRT download button
                    srt_download = get_file_download_link(srt_path, "subtitles.srt", "📥 Get SRT")
                ...
                # Celebration time
                st.balloons()
                st.markdown('<div class="success-box">🎉 Done! Grab your files above.</div>', unsafe_allow_html=True)
